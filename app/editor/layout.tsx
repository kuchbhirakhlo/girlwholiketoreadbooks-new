      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 px-6 py-5 border-b border-[#E6E1DA]">
            ...
            <span className="font-serif text-lg font-semibold text-[#2B2B2B]">Editor Portal</span>
            <button 
          ...
          <div className="px-4 py-4">
            <Link href="/editor/new" className="block">
              <Button className="w-full bg-[#8B5E3C] text-white hover:bg-[#8B5E3C]/90">
          ...
          <div className="border-t border-[#E6E1DA] p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#6F6F6F] capitalize">{user.role}</p>
              </div>
            </div>
            <div className="space-y-2">
              {user.role === 'admin' && (
                <Link href="/admin" className="block">
                  <Button variant="outline" className="w-full border-[#E6E1DA] text-[#6F6F6F] hover:bg-[#FAF8F5]">
                    Admin Dashboard
                  </Button>
                </Link>
              )}
              <Button
                ...
                className="w-full border-[#E6E1DA] text-[#6F6F6F] hover:bg-[#FAF8F5]"
              >
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-sm border-b border-[#E6E1DA]">
          <div className="flex items-center justify-between px-4 lg:px-8 py-4">
            <button
              className="lg:hidden p-2 text-[#6F6F6F]"
