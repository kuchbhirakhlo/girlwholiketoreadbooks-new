...
import { Star, MessageCircle, ThumbsUp, Copy, Check, Heart, Bookmark } from 'lucide-react';
...
export default function ReviewPage() {
  ...
  const shareText = post ? `Check out this review: ${post.title} by ${post.author}` : '';
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      try {
        ...
        setFavorites(favIds);
        setIsLiked(favIds.includes(id));
        setIsSaved(favIds.includes(id));
      } catch (error) {
